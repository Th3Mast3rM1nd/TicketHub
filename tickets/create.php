...
<head>
  ...
  <title>New ticket — TicketSystem</title>
...
<div class="dash">
  ...
  <main class="main">
    ...
    <div class="form-wrap">
      ...
      <div class="form-card">
        <form id="create-form" method="POST" action="/tickets/create.php">
        ...
        <div class="form-card-footer">
          <button type="submit" form="create-form" class="btn btn-primary">Create ticket</button>
